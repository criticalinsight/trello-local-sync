...
const KEYWORD_MAP: Record<string, string[]> = {
    'Coding': ['typescript', 'javascript', 'python', 'react', 'code', 'function', 'api', 'class', 'bug', 'fix', 'refactor', 'css', 'html', 'sql'],
    'Data': ['sql', 'database', 'query', 'dataset', 'analytics', 'statistics', 'chart', 'graph', 'excel', 'csv', 'json'],
    'Writing': ['email', 'blog', 'article', 'essay', 'draft', 'edit', 'proofread', 'summarize', 'tone', 'style'],
