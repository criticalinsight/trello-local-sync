            ...
            <div class="p-4 bg-slate-800 border-b border-slate-700 shrink-0">
                ...
                <div class="flex gap-4 h-32 items-end pb-2 px-2 border-l border-b border-slate-700 relative">
                    <Show
                        ...
                        fallback={
                            <div class="w-full text-center text-slate-500 self-center">
                                Not enough data
                            </div>
                        }
                    >
                            ...
                            {(d) => (
                                <div class="flex-1 flex flex-col justify-end items-center gap-1 group relative">
                                    ...
                                    <div
                                        ...
                                        style={{
                                            height: `${Math.max((d.latency / maxLatency()) * 100, 5)}%`,
                                        }}
                                    />
                            ...
                            <div class="flex justify-between items-start mb-1">
                                ...
                                <Show when={v.executionTime}>
                                    <span class="text-xs font-mono text-blue-400">
                                        {(v.executionTime! / 1000).toFixed(2)}s
                                    </span>
                                </Show>
                            </div>

                            <div class="flex items-center gap-2 text-xs text-slate-400 mb-2">
                                <span class="px-1.5 py-0.5 bg-slate-900 rounded">
                                    {v.parameters.model || 'Unknown Model'}
                                </span>
                                <span class="px-1.5 py-0.5 bg-slate-900 rounded">
                                    Temp: {v.parameters.temperature}
                                </span>
                            </div>
