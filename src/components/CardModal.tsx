...
export const CardModal: Component<CardModalProps> = (props) => {
    ...
    return (
        ...
        >
            <div
                class="bg-slate-800 w-full max-w-2xl rounded-xl shadow-2xl border border-slate-700 max-h-[90vh] overflow-y-auto"
                                    ...
                                    {(tag) => (
                                        <span class="bg-blue-900/50 text-blue-200 px-2 py-1 rounded text-sm border border-blue-800 flex items-center gap-1 group">
                                            ...
                                            <button
                                                ...
                                                class="hover:text-white opacity-60 hover:opacity-100"
                                            >
                                                ×
                                            </button>
                                        </span>
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                <Show when={card()?.dueDate}>
                                    <button
                                        onClick={() =>
                                            updateCardDetails(props.cardId, { dueDate: 0 })
                                        }
                                ...
                                <For each={card()!.checklist || []}>
                                    {(item) => (
                                        <div class="flex items-center gap-3 p-2 hover:bg-slate-700/30 rounded group">
                                            ...
                                            />
                                            <span
                                                class={`flex - 1 text - slate - 300 ${item.done ? 'line-through opacity-50' : ''} `}
                                            >
                                                {item.text}
                                            </span>
                                            <button
